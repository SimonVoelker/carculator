    ...
    for method in methods:
        ...
        for battery_production_country in battery_production_countries:
            ...
            for battery_capacity in battery_capacities:
                ...
                print(str(year) + ', ' + str(battery_capacity) + ' kWh, ' + battery_production_country + ', ' + method)
                ...
                for impact_category in impact_categories.keys():
                    ...
                    if not os.path.exists(path):
                        os.makedirs(path)
                    filename = str(year) + '_' + method + '_' + impact_category_short + '_' + vehicle_type + '_' +\
                               vehicle_size + '_BattCapacity_' + str(int(round(electric_energy_stored, 0))) + '_kWh_' +\
                               'BattCountry_' + str(battery_production_country)
